export function AlunosRow({ id, nome, email, telefone, endereco, onDelete = () => {} }) {
  return (
    <tr className="border-b border-gray-200 hover:bg-[#F3F4F8] transition-colors duration-150">
      ...
      <td className="px-4 py-3 text-center align-middle">
        <div className="flex justify-center gap-2">
          ...
          <button onClick={onDelete} className="px-4 py-2 bg-[#DC2625] text-white text-xs font-medium rounded-md hover:bg-[#B91C1C] shadow-sm hover:shadow-md transition-all duration-150 cursor-pointer">
            Excluir
          </button>
        </div>
      </td>
