export function CondominiosRow({ id, nome, cep, rua, numero, cidade, bairro, onDelete = () => {} }) {
  return (
    <tr className="border-b border-gray-200 hover:bg-[#F3F4F8] transition-colors duration-150">
      ...
      <td className="px-4 py-3 text-center align-middle">
        <div className="flex justify-center gap-2">
          ...
          <button onClick={onDelete} className="px-4 py-2 bg-red-600 text-white text-xs rounded-md hover:bg-red-700 shadow-sm transition-all">
            Excluir
          </button>
        </div>
      </td>
