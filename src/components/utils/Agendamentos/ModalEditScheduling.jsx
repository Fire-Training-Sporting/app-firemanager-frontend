...
export default function ModalEditScheduling({ agendamento, onClose }) {
  ...
  return (
    <div className="p-4 w-full min-h-[200px] max-h-[calc(100vh-100px)] flex flex-col">
      <h2 className="text-base font-semibold text-gray-800 mb-2">Editar Agendamento</h2>
